...
import {
  ...
  sponsorWalletsController,
  sponsorWalletTransactionController,
  sponsorWalletTransactionsController,
} from './sponsorWallet.controller';
import {
  SponsorWallet,
  SponsorWalletSchema,
  SponsorWalletTransaction,
  SponsorWalletTransactionSchema,
